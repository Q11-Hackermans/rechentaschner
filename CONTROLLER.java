...
public class CONTROLLER implements ActionListener
{
     ...
     * an die View. Anschließend fügt er die View in die Observer-Liste  des Models ein.
     * Zuletzt registriert er sich bei den beiden Buttons der View (dort werden 
    ...
    public CONTROLLER()
    {
        ? = new MODEL();
        ? = new VIEW(?);
        //Füge dem model die view als Observer über die entsprechende Methode des models hinzu
        ?
    ...
    /*
     * In dieser Methode wird festgelegt, wie auf bestimmte Aktionen reagiert werden soll. 
     * Über die Methode getActionCommand() kann abgefragt werden, welcher Knopf 
     * gedrückt wurde. Es wird dann die passende Methode im Model aufgerufen.
     * ACHTUNG: In dieser Variante der Methode ist auch schon das Einlesen von Werten enthalten. 
     * Wer den ursprünglichen Code ohne diese Funktion haben möchte, musst im ersten if-Teil
     * nur die Zeile model.inkrementieren() schreiben und die entsprechende Methode
     * im Model anpassen.
     * 
     * Wird in der View ein Button gedrückt, bei dem ein ActionListener hinterlegt ist, so wird diese Methode aufgerufen.
     * 
     */
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getActionCommand().equals("+"))
        {
            ...
            {
                /* 
                 * Es wird ein Eingabefenster (JOptionPane) mit der entsprechenden Nachricht angezeigt.
                 * Der Inhalt wird auf einen Integer gecastet, falls möglich.
                 * Ist es nicht möglich, weil der Benutzer z.B. einen Text eingegeben hat,
                 * kommt der catchBlock zur Aktion: Er greift diesen Fehler ab un zeigt die Fehlermeldung an.
                 * 
